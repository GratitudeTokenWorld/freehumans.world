...
const generateToken = (app) => {
    app.get('/generate-token', (0, limiter_1.createRateLimiter)(15, 15), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            ...
            yield scylladb_1.default.execute(queryUpsertSession, [ip_address, newToken, purpose, currentDate]);
