...
exports.sendShares = exports.checkEmail = exports.verifyCode = exports.sendCode = exports.location = void 0;
...
const location = (app) => {
    app.post('/location', (0, limiter_1.createRateLimiter)(10, 15), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
const sendCode = (app) => {
    app.get('/send-code', (0, limiter_1.createRateLimiter)(10, 15), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        `;
        try {
            yield scylladb_1.default.execute(query, [email, code]);
...
const verifyCode = (app) => {
    app.get('/verify-code', (0, limiter_1.createRateLimiter)(10, 15), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        const email = req.query.email;
        ...
        try {
            const result = yield scylladb_1.default.execute(query, [email], { prepare: true });
...
const checkEmail = (app) => {
    app.get('/checkEmail', (0, limiter_1.createRateLimiter)(10, 15), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        const emailChecked = String(req.query.email || '');
        try {
            // Query the database for the email
            const result = yield scylladb_1.default.execute('SELECT email FROM users WHERE email = ?', [emailChecked]);
...
function sendShareEmail(email, user, share) {
    const mailOptions = {
        from: 'noreply@freehumans.world',
        to: email,
...
const sendShares = (email, user, s1, s2, s3) => __awaiter(void 0, void 0, void 0, function* () {
    if (!email) {
    ...
    try {
        ...
        const userResult = yield scylladb_1.default.execute(userQuery, [user], { prepare: true });
        ...
        yield scylladb_1.default.execute(insertAppQuery, [userID, s1], { prepare: true });
        ...
        yield scylladb_1.default.execute(insertFaceIdQuery, [userID, s2], { prepare: true });
